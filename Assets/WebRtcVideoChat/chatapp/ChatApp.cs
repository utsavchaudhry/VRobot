...
namespace Byn.Unity.Examples
{
    ...
    public class ChatApp : MonoBehaviour
    {
        ...
        /// </summary>
        public string uSignalingUrl = ExampleGlobals.SignalingChatApp;
        ...
        private void SendString(string msg, bool reliable, ConnectionId id)
        {
            if (mNetwork == null || mConnections.Count == 0 || mConnections.Contains(id) == false)
            {
                Append("No connection. Can't send message.");
            }
            else
        ...
        {
            Setup();
            mNetwork.Connect(Application.productName);
            Append("Connecting to " + Application.productName + " ...");
        }
        ...
        public void OpenRoomButtonPressed()
        {
           ...
           // mNetwork.StartServer(uRoomName.text);
            mNetwork.StartServer(Application.productName);

            Debug.Log("StartServer " + Application.productName);
        }
