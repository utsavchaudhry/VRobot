...
static const uint8_t MOTOR_HW_ID_1 = 0x7E;  // hardware ID for motor #1 (e.g., "left" wheel)
static const uint8_t MOTOR_HW_ID_2 = 0x7F;  // hardware ID for motor #2 (e.g., "right" wheel)
